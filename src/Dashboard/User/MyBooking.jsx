...
const MyBooking = () => {
  ...
  const [deleteBooking, { isSuccess: cancelSuccess }] =
    useDeleteBookingMutation();
  const [updateBooking, { isSuccess: updateSuccess }] =
    useUpdateBookingMutation();
  console.log(data);

  const fBooking = data?.data?.filter((item) => item?.status === false);
  ...
  const confirmBooking = (bookingId) => {
    console.log("aaaaaaaaaaaaaaaa", bookingId);
    updateBooking({ id: bookingId, status: true });
  };
